...
namespace SkilledNPCs
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static ConfigEntry<bool> PlayMaxCards { get; set; }
        ...
        private void Awake()
        {
            ...
            PlayMaxCards = Config.Bind(new ConfigDefinition(PluginInfo.PLUGIN_NAME, "PlayMaxCards"), false, new ConfigDescription("If True, overrides NumberOfExtraCards to make NPCs play all possible cards. "));
